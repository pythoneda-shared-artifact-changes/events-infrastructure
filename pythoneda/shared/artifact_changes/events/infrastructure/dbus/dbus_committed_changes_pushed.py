...
class DbusCommittedChangesPushed(BaseObject, ServiceInterface):
    ...
    @signal()
    def CommittedChangesPushed(self, change: "s"):
        """
    ...
    def parse(cls, message: Message) -> CommittedChangesPushed:
        ...
        """
        repository_url, branch, event_id, prev_event_ids = message.body
        return CommittedChangesPushed(repository_url, branch, None, event_id, json.loads(prev_event_ids))
