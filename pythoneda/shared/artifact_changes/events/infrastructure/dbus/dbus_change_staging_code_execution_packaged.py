"""
pythoneda/shared/artifact_changes/events/infrastructure/dbus/dbus_change_staging_code_execution_packaged.py
...
class DbusChangeStagingCodeExecutionPackaged(BaseObject, ServiceInterface):
    ...
    def __init__(self):
        ...
        """
        super().__init__(
            "Pythoneda_Shared_artifact_changes_Events_ChangeStagingCodeExecutionPackaged"
        )

    @signal()
    def ChangeStagingCodeExecutionPackaged(self, nixFlake: "s"):
        """
        Defines the ChangeStagingExecutionPackaged d-bus signal.
    ...
    def parse(cls, message: Message) -> ChangeStagingCodeExecutionPackaged:
        ...
        :rtype: pythoneda.shared.artifact_changes.events.ChangeStagingCodeExecutionPackaged
        """
